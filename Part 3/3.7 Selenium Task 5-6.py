...
with webdriver.Chrome() as browser:
    browser.get(url)
    forms = browser.find_elements(By.CLASS_NAME, 'check')
    for form in forms:
        send_input = form.click()
...
# options_chrome.add_argument(r'user-data-dir=C:\Users\stari\AppData\Local\Google\Chrome\User Data')
# with webdriver.Chrome(options=options_chrome) as browser:
#     browser.get('https://parsinger.ru/selenium/4/4.html')
#     for i in browser.find_elements(By.XPATH, '//div/*[@class="check"]'):
#         i.click()
#     browser.find_element(By.XPATH, '//div/*[@class="btn"]').click()
#     res = browser.find_element(By.ID, 'result').text
#     browser.get('https://stepik.org/lesson/709437/step/11?unit=710000')
#     time.sleep(7)
#     browser.find_element(By.XPATH, '//div/*[@placeholder="Введите число"]').send_keys(res)
#     browser.find_element(By.XPATH, '//div/*[@class="submit-submission"]').click()
#     time.sleep(10)
...
with webdriver.Chrome() as browser:
    ...
    forms = browser.find_elements(By.CLASS_NAME, 'check')
    for form in forms:
        if int(form.get_attribute("value")) in numbers:
            send_input = form.click()
    button = browser.find_element(By.CLASS_NAME, 'btn').click()
    print(browser.find_element(By.ID, 'result').text)
    time.sleep(5)
